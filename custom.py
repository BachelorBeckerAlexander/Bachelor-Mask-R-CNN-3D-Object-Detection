...
def train(model):
    ...
    dataset_train.load_custom("C:/Users/Nutzer/anaconda3/envs/myenv/Mask_RCNN (works)/dataset/nucleus_jpg", "train")
    ...
    dataset_val.load_custom("C:/Users/Nutzer/anaconda3/envs/myenv/Mask_RCNN (works)/dataset/nucleus_jpg", "val")
    ...
    # no need to train all layers, just the head layers should do it
